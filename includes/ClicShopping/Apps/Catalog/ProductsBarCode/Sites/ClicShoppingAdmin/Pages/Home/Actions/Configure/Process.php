  ...
  class Process extends \ClicShopping\OM\PagesActionsAbstract  {
    public function execute() {
      ...
      foreach ($m->getParameters() as $key) {
        ...
        if (isset($_POST[$p])) {
          $CLICSHOPPING_ProductsBarCode->saveCfgParam($key, $_POST[$p]);
        }
      }

      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_ProductsBarCode->getDef('alert_cfg_saved_success'), 'success', 'products_barcode');
